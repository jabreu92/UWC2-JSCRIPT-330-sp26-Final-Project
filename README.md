...
- 1. A description of your project's context/subject matter (i.e. gaming, project management, image processing, etc.)
  - The Private Jet Business API is a Enterprise marketplace for customers who are in need of a private jet for their personal or business needs.
- 2. A description of what problem your project seeks to solve.
  - The Private Jet Business API intends to solve the issue of providing a one stop shop for any customers who want to find a private jet for their business or personal needs. In today's world, having the flexibility to travel at your convenience has become a must.
