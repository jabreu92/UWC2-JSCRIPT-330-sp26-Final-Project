...
- 1. A description of your project's context/subject matter (i.e. gaming, project management, image processing, etc.)
  - The Private Jet Business API is design to be used by E-Commerce sites that want to buy or sell Private Jets.
...
- 3. A description of what the technical components of your project will be, including: the routes, the data models, any external data sources you'll use, etc.
  - For this project we will have the following techincal components:
    ...
    - Routes:
      ...
      - Below is a Table with a list of the essentials routes. The Mixed term means Admins & Regulars can use this endpoint:

    - |  Method  | Endpoint |   | Access   | | Description |

    - |   POST   |   /jet       | Admin    | | Add new jet to the catalog 
    - |   GET    |   /jet       | Mixed    | | View All Jets 
    - |   GET    |   /jet/:sku  |  Mixed   | | View Specific Jet 
    ...
    - |   GET    |   /order   || Mixed    || Admin sees all orders, Regular Users sees only their own orders 
...
- 4. Clear and direct call-outs of how you will meet the various project requirements. 
    ...
    - Here are some of the business logic cases to go thru.
        ...
        - g. Verift the Purchased Jet is no longer in the Catalog.
